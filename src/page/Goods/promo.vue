    ...
    <div v-loading="loading" element-loading-text="加载中..." style="min-height: 35vw;">
      <div class="img-item">
        ...
        <div class="goods-box w">
          <mall-goods v-for="(item,i) in goods" :key="i" :msg="item" isShowBtn="promo"></mall-goods>
        </div>
      ...
      <div class="no-info" v-if="noResult">
        <div class="no-data">
          <img src="/resources/static/images/no-search.png">
          <br> 抱歉！暂时还没有商品
        </div>
...
<script>
  import { getPromoItems } from '/api/goods.js'
