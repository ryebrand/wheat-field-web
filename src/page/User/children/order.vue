            ...
            <div class="pr">
              <div class="cart" v-for="(good,j) in item.orderItems" :key="j">
                <div class="cart-l" :class="{bt:j>0}">
                  <div class="car-l-l">
                    <div class="img-box"><a @click="goodsDetails(good.itemId)"><img :src="good.imgUrl" alt=""></a></div>
              ...
              <div class="prod-operation pa" style="right: 0;top: 0;">
                ...
                <div class="status" v-if="item.status !== '0'"> {{getstatus(item.status)}}  </div>
              </div>
            </div>
          </div>
        </div>
