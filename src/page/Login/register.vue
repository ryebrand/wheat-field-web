        ...
        <div class="registered">
          ...
          <div class="content" style="margin-top: 20px;">
            <ul class="common-form">
              <li class="username border-1p">
                <div style="margin-top: 40px;" class="input">
                  <input type="text"
                         v-model="registered.telephone" placeholder="账号/手机号"
                         @keyup="registered.telephone=registered.telephone.replace(/[^\w\.\/]/ig,'')">
                </div>
              </li>
              <li class="username border-1p">
                <div class="input">
              ...
              <li class="username border-1p">
                <div class="input">
                  <input type="text"
                         v-model="registered.age" placeholder="年龄"
                         @keyup="registered.age=registered.age.replace(/[^\w\.\/]/ig,'')">
                </div>
              </li>
              <li class="username border-1p">
                <div class="input">
            ...
            <div style="margin-bottom: 30px;">
              <y-button
                :classStyle="registered.password&&registered.userPwd2&&registered.name&&registered.age&&registered.gender&&registered.telephone&&registxt==='注册'?'main-btn':'disabled-btn'"
                :text="registxt"
...
export default {
  ...
  methods: {
    ...
    regist () {
      this.registxt = '注册中...'
      let name = this.registered.name
      let password = this.registered.password
      let telephone = this.registered.telephone
      let age = this.registered.age
      let gender = this.registered.gender
      let userPwd2 = this.registered.userPwd2
      if (!name || !password || !userPwd2 || !telephone || !age || !gender) {
...
.login {
  ...
  .wrapper {
    background:url(/resources/static/images/bg_9b9dcb65ff.png) repeat;
...
.v2 .dialog {
  ...
  .title {
    ...
    position: relative;
    background-image: url(/resources/static/images/smartisan_4ada7fecea.png);
...
@media screen and (min-width: 737px),
  ...
  .wrapper {
    background:url(/resources/static/images/con-bg_04f25dbf8e.jpg) repeat-x;
    position: absolute;
    top: 0;
    bottom: 0;
    left: 0;
  ...
  .dialog {
    background:url(/resources/static/images/dialog-gray-bg.png) #fff bottom repeat-x;
    border-radius: 12px;
    display: none;
