    ...
    <y-shelf title="支付订单">
      <div slot="content">
        ...
        <div class="pay-type">
          ...
          <div class="pay-item">
            <div :class="{active:payType==1}" @click="payType=1"><img src="/resources/static/images/alipay@2x.png" alt=""></div>
            <div :class="{active:payType==2}" @click="payType=2"><img src="/resources/static/images/weixinpay@2x.png" alt=""></div>
            <div :class="{active:payType==3}" @click="payType=3"><img src="/resources/static/images/qqpay.png" alt=""></div>
          </div>
        </div>
      ...
      paySuc () {
        ...
        payMent({
          ...
          if (res.status === 'success') {
            ...
            this.payNow = '立刻支付'
            this.submit = true
            this.messageFail(res.data.errMsg)
          }
        })
      },
      isMoney (v) {
