    ...
    <div class="w" style="padding-top: 40px;">
        ...
        <div slot="content">
          <ul class="address-item-list clearfix">
            <li v-for="(item,i) in addList"
                ...
                @click="chooseAddress(item.addressId, item.userName, item.telephone, item.address)">
           <span v-if="addressId === item.addressId" class="pa">
             ...
             <path
              ...
              <p>收货人: {{item.userName}} {{item.default ? '(默认地址)' : ''}}</p>
                ...
                <div class="cart-group divide pr" :data-productid="item.itemId">
                  <div class="cart-top-items">
                    <div class="cart-items clearfix">
                      ...
                      <div>
                        <!--总价格-->
                        <div class="subtotal" style="font-size: 14px">¥ {{item.price * item.amount}}</div>
                        <!--数量-->
              ...
              <div class="fix-bottom-inner">
                ...
                <div class="pay-type">
                  <div class="pay-item">
                    ...
                    <div class="item" :class="{active:payType==1}" @click="payType=1"><img src="/resources/static/images/alipay@2x.png" alt=""></div>
                    <div class="item" :class="{active:payType==2}" @click="payType=2"><img src="/resources/static/images/weixinpay@2x.png" alt=""></div>
                    <div class="item" :class="{active:payType==3}" @click="payType=3"><img src="/resources/static/images/qqpay.png" alt=""></div>
                  </div>
                </div>
                <div class="shipping">
      ...
      <y-popup :open="popupOpen" @close='popupOpen=false' :title="popupTitle">
        <div slot="content" class="md" :data-id="msg.addressId">
          ...
          <div>
            <input type="number" placeholder="手机号码" v-model="msg.telephone">
          </div>
          <div>
          ...
          <y-button text='保存'
                    ...
                    @btnClick="save({userId:userId,addressId:msg.addressId,userName:msg.userName,telephone:msg.telephone,address:msg.address,isDefault:msg.isDefault})">
          </y-button>
        </div>
      </y-popup>
    </div>
...
<script>
  ...
  export default {
    ...
    computed: {
      btnHighlight () {
        let msg = this.msg
        return msg.userName && msg.telephone && msg.address
      },
      // 选中的总价格
      checkPrice () {
        let totalPrice = 0
    ...
    methods: {
      ...
      goodsDetails (id) {
        ...
        // window.open(window.location.origin + '#/goodsDetails?itemId=' + id)
      },
      _getCartList () {
      ...
      // 选择地址
      chooseAddress (addressId, userName, telephone, address) {
      ...
      update (item) {
        ...
        if (item) {
          ...
          this.msg.telephone = item.telephone
          this.msg.address = item.address
          this.msg.isDefault = item.default
    ...
    created () {
      ...
      if (query.itemId && query.num) {
        ...
        // this._getCartList()
        this.cartList = JSON.parse(window.sessionStorage.getItem('cartActive'))
      }
      this._addressList()
    },
    components: {
