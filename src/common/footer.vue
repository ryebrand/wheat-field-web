    ...
    <div class="container">
      <div class="siteinfo">
        ...
        <ul class="c0">
          <h3 class="c1">服务支持</h3>
          <ul>
            <li class="c2"><a class="c3">官方开源</a></li>
            <li class="c2"><a class="c3">项目前端</a></li>
            <li class="c2"><a class="c3">项目后端</a></li>
          </ul>
        </ul>
        <ul class="c0">
          <h3 class="c1">自助服务</h3>
          <ul>
            <li class="c2"><a class="c3">个人博客</a></li>
            <li class="c2"><a class="c3">个人简介</a></li>
            <li class="c2"><a class="c3">个人视频</a></li>
          </ul>
        </ul>
        <!--<ul class="c0">
          <h3 class="c1">其他项目</h3>
        ...
        <ul class="c0">
          <h3 class="c1">友情链接</h3>
          <ul>
            <li class="c2"><a class="c3" target="_blank" href="http://google.com/">谷歌</a></li>
            <li class="c2"><a class="c3" target="_blank" href="http://www.baidu.com">百度</a></li>
            <li class="c2"><a class="c3" target="_blank" href="https://cn.jianshu.org/">简书</a></li>
          </ul>
        </ul>
        <ul class="c0">
          <h3 class="c1">关注我吧</h3>
          <ul>
            <li class="c2"><a class="c3" target="_blank" href="http://wpa.qq.com">腾讯 QQ</a></li>
            <li class="c2"><a class="c3" target="_blank" href="http://weibo.com/">新浪微博</a></li>
            <li class="c2"><a class="c3" target="_blank" href="">官方邮箱</a></li>
          </ul>
        </ul>

        <ul class="c4">
          <li class="tel"><a class="c5" href="http://wpa.qq.com/msgrd?v=3&uin=1012139570&site=qq&menu=yes" target="_blank">1418862128</a></li>
