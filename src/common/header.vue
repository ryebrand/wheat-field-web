        ...
        <div class="w-box">
          <div class="nav-logo">
            <h1 @click="changePage(-1)">
              <router-link to="/" title="秒杀商城">秒杀商城</router-link>
            </h1>
          </div>
          <div class="right-box">
            <div class="nav-list">
                                  ...
                                  <div class="item-desc">
                                    <div class="cart-cell"><h4>
                                      ...
                                      <h6><span class="price-icon">¥</span><span
                                        ...
                                        class="item-num">x {{item.amount}}</span>
                                      </h6></div>
                                  </div>
                                </a>
          ...
          <div class="nav-sub-wrapper" :class="{fixed:st}">
            <div class="w">
              <ul class="nav-list2">
                ...
                <li>
                  <a @click="changGoods(-3)" :class="{active:choosePage===-3}">秒杀中</a>
                </li>
                <li v-for="(item,i) in navList" :key="i">
                  <a @click="changGoods(i, item)" :class="{active:i===choosePage}">{{item.imgUrl}}</a>
                </li>
              </ul>
              <div></div>
            </div>
...
<script>
  ...
  export default{
    ...
    methods: {
      ...
      delGoods (itemId) {
        if (this.login) { // 登陆了
          cartDel({userId: getStore('userId'), itemId}).then(res => {
...
<style lang="scss" rel="stylesheet/scss" scoped>
  ...
  .w-box {
    ...
    h1 {
      ...
      align-items: center;
      > a {
        background:url(/resources/static/images/global-logo-red@2x.png) no-repeat 50%;
    ...
    .user {
      ...
      > a {
        ...
        &:before {
          ...
          top: 0;
          @include wh(20px);
          background:url(/resources/static/images/account-icon@2x.32d87deb02b3d1c3cc5bcff0c26314ac.png) -155px 0;
    ...
    .shop {
      ...
      > a {
        ...
        &:before {
          ...
          @include wh(30px, 100%);
          content: " ";
          background:url(/resources/static/images/account-icon@2x.32d87deb02b3d1c3cc5bcff0c26314ac.png) 0 -22px;
          background-size: 240px 107px;
  ...
  .nav-user-wrapper {
    ...
    .nav-user-list {
      ...
      &:before {
        position: absolute;
        content: " ";
        background:url(/resources/static/images/account-icon@2x.32d87deb02b3d1c3cc5bcff0c26314ac.png) no-repeat -49px -43px;
        background-size: 240px 107px;
        @include wh(20px, 8px);
        top: -8px;
        margin-left: -10px;
  ...
  .cart-con:before {
    ...
    width: 76px;
    height: 62px;
    background: url("/resources/static/images/cart-empty-new.png") no-repeat;
    background-size: cover;
